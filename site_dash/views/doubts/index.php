...
<body class="d-flex flex-column min-vh-100">
    ...
    <header class="faq-header fade-in">
        <div class="container text-center position-relative z-2">
            ...
            <h1 class="display-3 fw-bold mb-4 text-white hero-title">
                ...
                <span class="text-warning">Frequentes</span>
            </h1>
                ...
                <div class="card shadow-sm mb-4 fade-in delay-2">
                    <div class="card-body contact-card">
                        ...
                        <div class="mb-3">
                            ...
                            <p>suporte@multigarantia.com.br</p>
                        </div>

                        <div class="mb-3">
                            <h5><i class="bi bi-telephone me-2"></i> Telefone</h5>
                            <p>(11) 1234-5678 (Seg-Sex, 9h-18h)</p>
                        </div>

                        <div class="mb-3">
                            <h5><i class="bi bi-chat-left-text me-2"></i> Chat Online</h5>
                            <p>Disponível no canto inferior direito da tela durante o horário comercial</p>
                        </div>
                    </div>
                </div>
    ...
    <script src="/site_dash/public/js/faq.js"></script>
</body>
